...
if ($databaseUrl) {
    ...
    define("DB_PASSWORD", $parsedUrl["pass"] ?: "KYNhVYJskNDfOQXCYtlfgMbtEmxIVRvn");
} else {
    define("DB_HOST", getenv("MYSQLHOST") ?: "mysql.railway.internal");
    define("DB_PORT", getenv("MYSQLPORT") ?: "3306");
    define("DB_NAME", getenv("MYSQLDATABASE") ?: "proyecto2web");
    define("DB_USERNAME", getenv("MYSQLUSER") ?: "root");
    define("DB_PASSWORD", getenv("MYSQLPASSWORD") ?: getenv("MYSQL_ROOT_PASSWORD") ?: "KYNhVYJskNDfOQXCYtlfgMbtEmxIVRvn");
}
